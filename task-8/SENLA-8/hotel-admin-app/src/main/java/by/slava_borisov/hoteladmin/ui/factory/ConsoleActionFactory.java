...
public class ConsoleActionFactory implements ActionFactory {
    ...
    @Override
    public Action createSaveGuestsAction() throws IllegalAccessException {
        SaveGuestsAction action = new SaveGuestsAction(consoleUI);
        DIUtil.injectDependencies(action);
        return action;
    }

    @Override
    public Action createSaveRoomsAction() throws IllegalAccessException {
        SaveRoomAction action = new SaveRoomAction(consoleUI);
        DIUtil.injectDependencies(action);
        return action;
    }

    @Override
    public Action createSaveAmenitiesAction() throws IllegalAccessException {
        SaveAmenityAction action = new SaveAmenityAction(consoleUI);
        DIUtil.injectDependencies(action);
        return action;
    }

    @Override
    public Action createSaveBookingsAction() throws IllegalAccessException {
        SaveBookingAction action = new SaveBookingAction(consoleUI);
        DIUtil.injectDependencies(action);
        return action;
    }

    @Override
    public Action createLoadGuestsAction() throws IllegalAccessException {
        LoadGuestsAction action = new LoadGuestsAction(consoleUI);
        DIUtil.injectDependencies(action);
        return action;
    }

    @Override
    public Action createLoadRoomsAction() throws IllegalAccessException {
        LoadRoomAction action = new LoadRoomAction(consoleUI);
        DIUtil.injectDependencies(action);
        return action;
    }

    @Override
    public Action createLoadAmenitiesAction() throws IllegalAccessException {
        LoadAmenityAction action = new LoadAmenityAction(consoleUI);
        DIUtil.injectDependencies(action);
        return action;
    }

    @Override
    public Action createLoadBookingsAction() throws IllegalAccessException {
        LoadBookingAction action = new LoadBookingAction(consoleUI);
        DIUtil.injectDependencies(action);
        return action;
    }
    ...
    @Override
    public Action createSaveAmenityUsageAction() throws IllegalAccessException {
        SaveAmenityUsageAction action = new SaveAmenityUsageAction(consoleUI);
        DIUtil.injectDependencies(action);
        return action;
    }

    @Override
    public Action createLoadAmenityUsageAction() throws IllegalAccessException {
        LoadAmenityUsageAction action = new LoadAmenityUsageAction(consoleUI);
        DIUtil.injectDependencies(action);
        return action;
    }
}
