...
public class MainMenu extends Menu {
    ...
    public MainMenu(ActionFactory actionFactory) {
        ...
        try {
            ...
            addMenuItem("28. " + Messages.MENU_ITEM_SAVE_AMENITY_USAGE, actionFactory.createSaveAmenityUsageAction());
            addMenuItem("29. " + Messages.MENU_ITEM_LOAD_GUESTS, actionFactory.createLoadGuestsAction());
            addMenuItem("30. " + Messages.MENU_ITEM_LOAD_ROOMS, actionFactory.createLoadRoomsAction());
            addMenuItem("31. " + Messages.MENU_ITEM_LOAD_BOOKINGS, actionFactory.createLoadBookingsAction());
            addMenuItem("32. " + Messages.MENU_ITEM_LOAD_AMENITIES, actionFactory.createLoadAmenitiesAction());
            addMenuItem("33. " + Messages.MENU_ITEM_LOAD_AMENITY_USAGE, actionFactory.createLoadAmenityUsageAction());
            addMenuItem("0. " + Messages.MENU_ITEM_EXIT, () -> System.exit(0));
        } catch (IllegalAccessException e) {
            throw new RuntimeException(Messages.FAILED_TO_CREATE_MENU_ITEMS ,e);
        }
    }
