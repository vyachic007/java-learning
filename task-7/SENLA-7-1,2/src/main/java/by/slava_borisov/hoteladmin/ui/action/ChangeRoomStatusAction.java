    ...
    public void execute() {
        ...
        try {
            ...
            if (room != null) {
                ...
                consoleUI.print("1. " + consoleUI.translateRoomStatus(RoomStatus.AVAILABLE) + "\n");
                consoleUI.print("2. " + consoleUI.translateRoomStatus(RoomStatus.OCCUPIED) + "\n");
                consoleUI.print("3. " + consoleUI.translateRoomStatus(RoomStatus.UNDER_MAINTENANCE) + "\n");
                consoleUI.print("4. " + consoleUI.translateRoomStatus(RoomStatus.CLEANING) + "\n");
