...
public class HotelFacade {
    ...
    public Result<Boolean> updateAmenityPrice(int amenityId, double price) {
        ...
        } catch (AmenityNotFoundException e) {
            return Result.failure(Messages.AMENITY_NOT_FOUND);
        } catch (IllegalArgumentException e) {
            return Result.failure(e.getMessage());
        } catch (Exception e) {
            return Result.failure(Messages.ERROR_PREFIX + Messages.UNKNOWN_PRICE_UPDATE_ERROR);
        }
    }
