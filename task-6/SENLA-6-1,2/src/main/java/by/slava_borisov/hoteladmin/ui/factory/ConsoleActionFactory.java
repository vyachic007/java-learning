...
public class ConsoleActionFactory implements ActionFactory {
    ...
    @Override
    public Action createSaveAmenityUsageAction() {
        return new SaveAmenityUsageAction(bookingController.getHotelSystem(), consoleUI);
    }
    ...
    @Override
    public Action createLoadAmenityUsageAction() {
        return new LoadAmenityUsageAction(bookingController.getHotelSystem(), consoleUI);
    }
